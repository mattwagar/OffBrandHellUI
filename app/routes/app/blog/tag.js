...
export default Ember.Route.extend({
    ...
    model(params) {
        ...
        return Ember.RSVP.hash({
            ...
            posts: Ember.$.get(`https://www.googleapis.com/blogger/v3/blogs/1010553031835188559/posts/search?q=label:"${params.tag_name}"&maxResults=20&key=AIzaSyAlS7uOny5TTTmpMla3QNRU8Hy0KLEZqSg`, function (response) {
                return response;
            }),
